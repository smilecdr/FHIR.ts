...
describe('QueryBuilder', () => {
  ...
  it('revinclude() should make query for multiple _revinclude', () => {
    ...
    const expected: String =
      'MedicationRequest?_revinclude=CarePlan%3Aactivity-reference&_revinclude=Observation%3Abased-on';
    // execute
    queryBuilder
      .setBaseResource('MedicationRequest')
  ...
  it('include() and revinclude() should make query for _include & _revinclude', () => {
    // setup
    const expected: String =
      'MedicationRequest?_revinclude=CarePlan%3Aactivity-reference&_include=MedicationRequest%3Aencounter';
    // execute
    queryBuilder
      .setBaseResource('MedicationRequest')
      .revinclude('CarePlan', 'activity-reference')
