...
export namespace PlanDefinitionCondition {
    export type KindEnum = 'applicability' | 'start' | 'stop';
    export const KindEnum = {
        Applicability: 'applicability' as KindEnum,
        Start: 'start' as KindEnum,
        Stop: 'stop' as KindEnum
    };
}
