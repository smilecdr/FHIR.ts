...
export namespace MessageHeaderResponse {
    export type CodeEnum = 'ok' | 'transient-error' | 'fatal-error';
    export const CodeEnum = {
        Ok: 'ok' as CodeEnum,
        TransientError: 'transient-error' as CodeEnum,
        FatalError: 'fatal-error' as CodeEnum
    };
}
