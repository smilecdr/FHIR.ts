...
export namespace SpecimenDefinitionTypeTested {
    export type PreferenceEnum = 'preferred' | 'alternate';
    export const PreferenceEnum = {
        Preferred: 'preferred' as PreferenceEnum,
        Alternate: 'alternate' as PreferenceEnum
    };
}
